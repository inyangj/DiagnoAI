...
const SigninForm = () => {
  return (
    <form>
          ...
          <div className="flex p-[0.75rem] border border-gray_4 rounded-[0.27rem] items-center gap-2 mb-5">
            <img src={sms} alt="input-icon" />
            <input type="email" className="w-full" name="email" placeholder="ex. danny@email.com" id="email" />
          </div>
          ...
          <label className="text-[0.875rem]" htmlFor="password">Enter Password</label>
            <div className="flex p-[0.75rem] border border-gray_4 rounded-[0.27rem] items-center gap-2 mb-8">
                ...
                <input type="password" className="w-full" name="password" placeholder="ex. abc1234" id="password" />
